; Custom French strings for the Archifiltre installer (nsis.customLanguageFiles).
; NSIS stock French reads "de Archifiltre"; French elision needs d + U+2019 before a
; vowel. These override the window caption and the welcome/finish titles, and every
; apostrophe here is the typographic U+2019. Included after MUI_LANGUAGE "French",
; so these LangString definitions take precedence over the stock ones.
...
; --- French elision fixes (d’Archifiltre) ---
LangString ^SetupCaption ${LANG_FRENCH} "Installation d’${PRODUCTNAME}"
LangString ^UninstallCaption ${LANG_FRENCH} "Désinstallation d’${PRODUCTNAME}"
LangString MUI_TEXT_WELCOME_INFO_TITLE ${LANG_FRENCH} "Bienvenue dans le programme d’installation d’${PRODUCTNAME}"
LangString MUI_TEXT_FINISH_INFO_TITLE ${LANG_FRENCH} "Fin de l’installation d’${PRODUCTNAME}"
LangString MUI_UNTEXT_WELCOME_INFO_TITLE ${LANG_FRENCH} "Bienvenue dans le programme de désinstallation d’${PRODUCTNAME}"
LangString MUI_UNTEXT_FINISH_INFO_TITLE ${LANG_FRENCH} "Fin de la désinstallation d’${PRODUCTNAME}"
